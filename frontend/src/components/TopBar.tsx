import { Sun, Moon, Save, GitPullRequest, Play, ChevronDown, Check, Menu } from 'lucide-react';
...
export function TopBar({ workflowName, version, onRun, onToggleWorkflow, workflowOpen, onOpenMobileSidebar }: TopBarProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          onClick={onRun}
          className="flex items-center gap-1.5 rounded-lg px-4 py-2 text-[14px] font-semibold transition-all hover:scale-[1.02]"
