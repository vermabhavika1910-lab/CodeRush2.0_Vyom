...
export function HomePage({ onOpenWorkflow, onSubmitPrompt, isRunning, currentPrompt, onStopOrchestration }: HomePageProps) {
  return (
    <div className="flex flex-1 min-w-0 overflow-hidden">
      <div className="flex flex-1 items-center justify-center overflow-y-auto p-5 sm:p-8 lg:p-10">
        <PromptComposer 
          ...
          onStopOrchestration={onStopOrchestration}
        />
      </div>
